    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        >
          <Image
            priority
            src={withBasePath("/images/header-res-homepage.png")}
          ...
          <Image
            priority
            src={withBasePath("/images/header-homepage.png")}
          ...
          <Image
            priority
            src={withBasePath("/icons/big-star.svg")}
            height={104}
            width={104}
            alt="big star"
          ...
          <Image
            priority
            src={withBasePath("/icons/small-star.svg")}
            height={56}
            width={56}
            alt="small star"
